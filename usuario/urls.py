...
from .views import listagemUsuariosView, register, usuarioCreateView, usuarioUpdateView, usuarioDeleteView
...
urlpatterns = [
    ...
    path('novo/register', login_required(register), name='register')
]